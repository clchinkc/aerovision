        ...
        <div className="px-20 py-9 bg-white border-2 border-black border-solid max-md:px-5 max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col">
            <div className="flex flex-col w-[56%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow text-4xl font-bold text-center whitespace-nowrap text-stone-950 max-md:mt-10">
            ...
            <div className="flex flex-col ml-5 w-[44%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-center text-4xl font-bold text-center whitespace-nowrap text-stone-950 max-md:mt-10">
                {categories.map((category, index) => (
